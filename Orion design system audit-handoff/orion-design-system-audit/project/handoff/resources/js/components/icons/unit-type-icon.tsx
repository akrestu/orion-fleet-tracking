// resources/js/components/icons/unit-type-icon.tsx
// Line-silhouette icons for the 7 heavy-equipment classes, drawn to match
// the Lucide stroke style already used by shadcn/ui (24px grid, 1.6 stroke,
// round caps/joins, currentColor). Swap the paths here if you receive an
// official equipment icon set from a vendor — the API stays the same.

import * as React from "react";
import type { UnitType } from "@/lib/fleet";

const PATHS: Record<UnitType, React.ReactNode> = {
  oht: (
    <>
